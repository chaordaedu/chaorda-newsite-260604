    ...
    <>
      ...
      >
        <div className="bg-porcelain p-5 shadow-polish ring-1 ring-boundary">
          <p className="technical-label text-ink">Architecture Flow</p>
          <ol className="mt-4 grid gap-2">
            {[
              ...
              <li key={item} className="flex items-center gap-3 text-xs text-muted">
                <span className="mono-table grid size-6 place-items-center rounded bg-paper text-[10px] font-bold text-ink ring-1 ring-ink/5">
      ...
      >
        <div className="overflow-hidden rounded border border-boundary bg-porcelain shadow-technical">
          <table className="w-full min-w-[720px] text-left text-[11px]">
            <thead className="bg-ink text-porcelain">
              <tr>
                <th className="p-3 technical-label">Metric</th>
                <th className="p-3 technical-label">Focus</th>
                <th className="p-3 technical-label">Risk Mitigated</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-boundary">
              {[
                ...
                <tr key={metric} className="transition-colors hover:bg-paper/30">
                  <td className="p-3 font-bold text-ink">{metric}</td>
                  <td className="p-3 text-muted">{question}</td>
                  <td className="p-3 text-muted">{risk}</td>
                </tr>
              ))}
            </tbody>
          </table>
